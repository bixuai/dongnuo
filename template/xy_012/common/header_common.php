<?php echo 'http://www.comsenz.com';exit;?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <LINK id=layerslider_css-css rel=stylesheet type=text/css href="$_G['style'][styleimgdir]/layerslider.css" media=all>
<LINK id=font-awesome-css rel=stylesheet type=text/css href="$_G['style'][styleimgdir]/font-awesome.min.css" media=all>
<LINK id=stylesheet-css rel=stylesheet type=text/css href="$_G['style'][styleimgdir]/stylesheet.min.css" media=all>
<LINK id=woocommerce-css rel=stylesheet type=text/css href="$_G['style'][styleimgdir]/woocommerce.css" media=all>
<LINK id=woocommerce_responsive-css rel=stylesheet type=text/css href="$_G['style'][styleimgdir]/woocommerce_responsive.css" media=all>
<LINK id=responsive-css rel=stylesheet type=text/css href="$_G['style'][styleimgdir]/responsive.min.css" media=all>
<SCRIPT type=text/javascript src="$_G['style'][styleimgdir]/jquery.js"></SCRIPT>
<SCRIPT type=text/javascript src="$_G['style'][styleimgdir]/default.js"></SCRIPT>
<SCRIPT type=text/javascript src="$_G['style'][styleimgdir]/plugins.js"></SCRIPT>
<SCRIPT type=text/javascript src="$_G['style'][styleimgdir]/default_dynamic.js"></SCRIPT>
