...
<footer>
     <?php include template('common/footer_nav'); ?><div class="footer_bottom_holder">
<div class="footer_bottom">
<div>Powered by <strong><a href="http://www.comsenz.com" target="_blank">Discuz!</a></strong> <em><?php echo $_G['setting']['version'];?></em> Copyright &copy; <a href="http://www.comsenz.com" target="_blank">Comsenz Inc.</a> 	<?php if($_G['setting']['icp']) { ?>( <a href="http://www.miitbeian.gov.cn/" target="_blank"><?php echo $_G['setting']['icp'];?></a> )<?php } ?> 
<?php if(!empty($_G['setting']['pluginhooks']['global_footerlink'])) echo $_G['setting']['pluginhooks']['global_footerlink'];?>
<?php if($_G['setting']['statcode']) { ?><?php echo $_G['setting']['statcode'];?><?php } ?> <a href="http://bbwuyu.taobao.com" target="_blank">加田小店</a></div>
</div>
</div>
</footer>
